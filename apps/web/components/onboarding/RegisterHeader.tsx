  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-surface-container-lowest/80 shadow-[0_1px_8px_rgba(0,0,0,0.04)] backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-[1200px] items-center justify-between gap-space-md px-screen-margin-mobile lg:px-screen-margin-desktop">
        ...
        <nav className="flex items-center gap-space-sm md:gap-space-md">
          <Link
            className="hidden font-inter text-body-md text-on-surface-variant transition-colors hover:text-on-surface md:inline"
            href="#"
          >
            Public Explore
          </Link>
          <Link
            className="hidden font-inter text-body-md text-on-surface-variant transition-colors hover:text-on-surface sm:inline"
            href="/login"
          >
            Sign In
          </Link>
          <Link
            aria-current="page"
            className="rounded-lg bg-surface-container-high px-space-sm py-space-xs font-inter text-body-md font-bold text-primary transition-colors md:px-space-md md:py-space-sm"
            href="/register"
          >
            Sign Up
          </Link>
